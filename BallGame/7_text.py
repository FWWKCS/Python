...
# 적 enemy 스프라이트
enemy = pygame.image.load("C:/Users/김찬식/Desktop/Python Works/Import/BallGame/enemy.png")
enemy_size = enemy.get_rect().size  # 이미지 크기 확인
enemy_width = enemy_size[0] # 가로 크기
enemy_height = enemy_size[1] # 세로 크기
enemy_x_pos = (screen_width / 2) - (enemy_width / 2) # 화면 가로의 반 크기에 해당하는 곳에 위치
enemy_y_pos = (screen_height / 2) - (enemy_height / 2)# 화면 맨 아래에 위치 
...
while running:
    ...
    character_rect = character.get_rect() # 좌표, 너비, 높이 정보 전달
